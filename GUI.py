...
# ------ Menu Definition ------ #
menu_def = [['File', ['Import Audio']],['Editor', ['Trim','Overwrite']],['Help', ['User Guide','About...']]]
# ------ Frame Definition ------ #
...
frame_layout_audio_list=[[sg.Text('Recording List:'),sg.Button('Import Audio')],[sg.Table(headings=header,values=audio_info_list,key="-TABLE-", auto_size_columns=True,enable_events=True,starting_row_number=1)]]
...
layout = [
    ...
    [sg.Text(time_constant,key='-Eplased_Playtime-'),sg.Text("/"),sg.Text(time_constant,key='-Audio_Length-'),sg.Slider((0,kk:=600), key='-play-length-',size=(90,10),orientation="h",enable_events=True)],
