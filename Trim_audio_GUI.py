...
def Trim_audio_GUI(audio_directory,selected_audio_name,selected_audio_length):
    valid=False
    total_seconds=0
    ...
    layout_audio_trim=[[sg.Text('Selected Audio to Trim:'),sg.Text(selected_audio_name)],
    ...
    if valid:
        window = sg.Window('Audio Trimmer', layout_audio_trim)
        while True:
